...
import { CalendarDays, MapPin, Clock, Users, QrCode, Hotel as HotelIcon, CheckCircle, XCircle } from "lucide-react";
          ...
          <div className="flex items-center gap-4">
            {booking.qrCode && (
              <div className="flex items-center gap-2 bg-blue-50 px-3 py-2 rounded">
                ...
                <span className="text-sm font-mono text-blue-800">{booking.qrCode}</span>
              </div>
            )}
